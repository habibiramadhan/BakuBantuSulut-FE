...
export default function VolunteerPage() {
  ...
  const [counts, setCounts] = useState({ volunteers: 0, hours: 0, projects: 0 });
  const targetCounts = { volunteers: 250, hours: 5000, projects: 35 };
      ...
      setCounts(prevCounts => {
        ...
        (Object.keys(targetCounts) as Array<keyof typeof targetCounts>).forEach(key => {
          if (newCounts[key] < targetCounts[key]) {
            const increment = Math.ceil(targetCounts[key] / 50);
        ...
        <div className="container mx-auto px-6">
          ...
          >
            <motion.div 
              ...
              variants={fadeIn}
            >
              <h3 className="text-5xl font-bold text-babyBlue mb-2">{counts.volunteers}+</h3>
            ...
            <motion.div 
              ...
              variants={fadeIn}
            >
              <h3 className="text-5xl font-bold text-poppy mb-2">{counts.hours}+</h3>
            ...
            <motion.div 
              ...
              variants={fadeIn}
            >
              <h3 className="text-5xl font-bold text-mango mb-2">{counts.projects}+</h3>
  ...
  const ProgramsSection = () => {
    ...
    const programs = [
      ...
      },
      {
        ...
        image: "/images/volunteer-creative.jpg"
      },
      {
    ...
    return (
      <section className="py-16 bg-gradient-to-r from-poppy to-poppy-dark text-white relative overflow-hidden">
        <div className="absolute inset-0 mix-blend-overlay opacity-20">
          <Image 
            src="/images/volunteer-cta-pattern.jpg" 
            alt="Pattern" 
            fill 
            className="object-cover"
          />
