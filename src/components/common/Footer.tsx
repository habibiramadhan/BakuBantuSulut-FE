        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 pb-14 border-b border-gray-700">
          <div>
            ...
            <div className="flex space-x-4">
              <a 
                href="#" 
                className="w-9 h-9 rounded-full bg-lavender/20 flex items-center justify-center hover:bg-lavender/40 transition-colors"
                aria-label="Facebook"
              >
              ...
              <a 
                href="#" 
                className="w-9 h-9 rounded-full bg-poppy/20 flex items-center justify-center hover:bg-poppy/40 transition-colors"
                aria-label="Twitter"
              >
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-start">
                ...
                <p className="text-gray-400">
                  info@bakubantu.id<br />
                  bantuan@bakubantu.id
                </p>
              </li>
            </ul>
          </div>
